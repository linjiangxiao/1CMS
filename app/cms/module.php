...
class cms_module {
    ...
    function add($module_add_query) {
        ...
        if(isset($module_add_query['configs']) && is_array($module_add_query['configs'])){
            $module_add_query['configs']=json_encode($module_add_query['configs']);
        }
    ...
    function edit($module_edit_query) {
        ...
        if(isset($module_edit_query['configs']) && is_array($module_edit_query['configs'])){
            $module_edit_query['configs']=json_encode($module_edit_query['configs']);
        }
