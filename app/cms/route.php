...
class cms_route {
    ...
    function add($route_add_query) {
        ...
        if(C('this:route:get',$route_add_query['hash'],$route_add_query['modulehash'],$route_add_query['classhash'])) {
            Return false;
        }
        ...
        if(strpos($route_add_query['classview'],'<') || strpos($route_add_query['classview'],'>') || strpos($route_add_query['classview'],'|') || strpos($route_add_query['classview'],'?') || strpos($route_add_query['classview'],'"')) {
            Return false;
        }
    ...
    function edit($route_edit_query) {
        ...
        if(isset($route_edit_query['classview'])){
            if(strpos($route_edit_query['classview'],'<') || strpos($route_edit_query['classview'],'>') || strpos($route_edit_query['classview'],'|') || strpos($route_edit_query['classview'],'?') || strpos($route_edit_query['classview'],'"')) {
                Return false;
            }
        }
