...
<div class="layui-form">
    <input type="hidden" name="_last_update_time" value="{$last_update_time}">
...
<script>layui.use(['index'],function(){
    layui.form.on('submit(form-submit)', function(data){
        ...
        layui.admin.req({type:'post',url:"{$url.infoSave}",data:data.field,async:true,tips:'提交中...',popup:true});
    });
});
</script>
{/if}
